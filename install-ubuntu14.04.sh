...
c_print "yellow" "Cmake is too old for compiling p4c!" 1
c_print "yellow" "[SKIPPING]"
c_print "blue" "Use containerized version: https://hub.docker.com/r/cslev/p4c/"
...
c_print "green" "EVERYTHING IS INSTALLED (except p4c)"
